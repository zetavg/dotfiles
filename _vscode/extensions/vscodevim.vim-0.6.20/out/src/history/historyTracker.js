...
class HistoryTracker {
    ...
    _initialize() {
        this.historySteps.push(new HistoryStep({
            changes: [new DocumentChange(new position_1.Position(0, 0), this.getAllText(), true)],
            isFinished: true,
        ...
        */
        ...
        for (const diff of diffs) {
            ...
            if (added || removed) {
                ...
                if (this.currentHistoryStep.changes.length > configuration_1.Configuration.history) {
