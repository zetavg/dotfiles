        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.currentMode === mode_1.ModeName.Visual ||
                ...
                text = vimState.allCursors.map(range => {
                    ...
                    return vimState.editor.document.getText(new vscode.Range(start, vimState.currentMode === mode_1.ModeName.Insert ?
                        stop :
                        stop.getRight()));
                }).join("\n");
            }
                ...
                text = vimState.allCursors.map(range => {
                    return vimState.editor.document.getText(new vscode.Range(range.start.getLineBegin(), range.stop.getLineEnd()));
                }).join("\n");
            }
...
function searchCurrentWord(position, vimState, direction, isExact) {
    ...
    vimState.globalState.searchState = new searchState_1.SearchState(direction, vimState.cursorPosition, searchString, { isRegex: isExact });
...
let ChangeOperator = class ChangeOperator extends BaseOperator {
    ...
    run(vimState, start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isBeginning = end.isLineBeginning() &&
...
let SelectAnExpandingBlock = class SelectAnExpandingBlock extends TextObjectMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const ranges = [
                yield new MoveASingleQuotes().execAction(position, vimState),
                yield new MoveADoubleQuotes().execAction(position, vimState),
                yield new MoveAClosingCurlyBrace().execAction(position, vimState),
                yield new MoveAParentheses().execAction(position, vimState),
                yield new MoveASquareBracket().execAction(position, vimState),
            ];
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.includeSurrounding) {
                ...
                else if (/^\s+$/.test(textEditor_1.TextEditor.getText(new vscode.Range(endPos.getLineBegin(), endPos.getLeft())))) {
...
class MoveTagMatch extends BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (end === start) {
                return {
                    start: new position_1.Position(position.line, start),
                    stop: new position_1.Position(position.line, start),
                    failed: true,
                };
            }
            let startPos = new position_1.Position(position.line, start);
...
class BaseEasyMotionCommand extends BaseCommand {
    ...
    processMarkers(matches, position, vimState) {
        ...
        for (var j = 0; j < matches.length; j++) {
            ...
            vimState.easyMotion.addMarker(easymotion_1.EasyMotion.generateMarker(index++, matches.length, position, pos));
        }
    }
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
...
let CommandSurroundModeStart = class CommandSurroundModeStart extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Normal];
        this.keys = ["s"];
...
let CommandSurroundModeStartVisual = class CommandSurroundModeStartVisual extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = ["S"];
...
let CommandSurroundAddTarget = class CommandSurroundAddTarget extends BaseCommand {
    constructor() {
        super(...arguments);
...
let CommandSurroundAddToReplacement = CommandSurroundAddToReplacement_1 = class CommandSurroundAddToReplacement extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.SurroundInputMode];
        this.keys = ["<any>"];
    ...
    static TryToExecuteSurround(vimState, position) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (target === "t") {
                let { start, stop, failed } = yield new MoveAroundTag().execAction(position, vimState);
                let tagEnd = yield new MoveInsideTag().execAction(position, vimState);
...
var PutCommand_1, MoveRepeatReversed_1, ActionVisualReflowParagraph_1, MoveToMatchingBracket_1, ToggleCaseOperator_1, CommandSurroundAddToReplacement_1;
