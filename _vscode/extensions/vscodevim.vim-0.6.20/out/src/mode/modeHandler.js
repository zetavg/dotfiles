...
class RecordedState {
    constructor() {
         ...
         */
        this.count = 0;
        const useClipboard = configuration_1.Configuration.useSystemClipboard;
...
class ModeHandler {
    ...
    handleSelectionChange(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.currentModeName === mode_1.ModeName.VisualBlockInsertMode ||
                this.currentModeName === mode_1.ModeName.EasyMotionMode) {
                // AArrgghhhh - johnfn
                return;
            }
            if ((e.selections.length !== this.vimState.allCursors.length || this.vimState.isMultiCursor) &&
                ...
                this.vimState.allCursors = vscode.window.activeTextEditor.selections.map(x => new range_1.Range(position_1.Position.FromVSCodePosition(x.start), position_1.Position.FromVSCodePosition(x.end)));
    ...
    handleKeyEventHelper(key, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result === actions_1.KeypressState.NoPossibleMatch && !isPotentialRemapping) {
            ...
            if (recordedState.actionsRun.length === 0) {
                ...
                if (lastAction instanceof actions_1.DocumentContentChangeAction) {
                    ...
                    if (action instanceof actions_1.CommandInsertInInsertMode || action instanceof actions_1.CommandInsertPreviousText) {
                         ...
                         */
                        const startsWithPairedCharacter = (x) => x.startsWith("(") ||
                            x.startsWith("[") ||
                            x.startsWith("[") ||
                            x.startsWith("'") ||
                            x.startsWith("\"") ||
                        ...
                        lastAction.contentChanges = lastAction.contentChanges.concat(vimState.historyTracker.currentContentChanges.map(x => ({
                            textDiff: x,
                            positionDiff: startsWithPairedCharacter(x.text) ? new position_1.PositionDiff(0, -1) : new position_1.PositionDiff(0, 0),
                        })));
    ...
    updateView(vimState, args = { drawSelection: true, revealRange: true }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let cursorRange = [];
            // Draw block cursor.
            if (configuration_1.Configuration.useSolidBlockCursor) {
                yield vscode.workspace
                    .getConfiguration("editor")
                    .update("cursorBlinking", this.currentMode.name !== mode_1.ModeName.Insert ? "solid" : "blink", true);
            }
