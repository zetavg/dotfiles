...
class Register {
    ...
    static ProcessNumberedRegister(content, vimState) {
        ...
        const baseOperator = vimState.recordedState.actionsRun.find((value) => {
            return value instanceof actions_1.BaseOperator ||
                value instanceof actions_1.BaseCommand;
        });
        if (baseOperator instanceof actions_1.YankOperator || baseOperator instanceof actions_1.CommandYankFullLine) {
        ...
        else if (baseOperator instanceof actions_1.DeleteOperator && !(vimState.isRecordingMacro || vimState.isReplayingMacro)) {
    ...
    static getByKey(register, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Register.isClipboardRegister(register)) {
                ...
                let registerText;
                if (text instanceof modeHandler_1.RecordedState) {
                    registerText = text;
                }
                else {
