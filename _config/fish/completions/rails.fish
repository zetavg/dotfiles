...
complete -f -c rails -n '__fish_rails_using_command generate' -a assets
complete -f -c rails -n '__fish_rails_using_command generate' -a channel
complete -f -c rails -n '__fish_rails_using_command generate' -a controller
complete -f -c rails -n '__fish_rails_using_command generate' -a generator
complete -f -c rails -n '__fish_rails_using_command generate' -a helper
complete -f -c rails -n '__fish_rails_using_command generate' -a integration_test
complete -f -c rails -n '__fish_rails_using_command generate' -a jbuilder
complete -f -c rails -n '__fish_rails_using_command generate' -a job
complete -f -c rails -n '__fish_rails_using_command generate' -a mailer
complete -f -c rails -n '__fish_rails_using_command generate' -a migration
complete -f -c rails -n '__fish_rails_using_command generate' -a model
complete -f -c rails -n '__fish_rails_using_command generate' -a resource
complete -f -c rails -n '__fish_rails_using_command generate' -a scaffold
complete -f -c rails -n '__fish_rails_using_command generate' -a scaffold_controller
complete -f -c rails -n '__fish_rails_using_command generate' -a task
